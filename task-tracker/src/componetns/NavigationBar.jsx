...
function NavigationBar() {
  const [practice1DivVisible, setPractice1DivVisible] = useState(false);
  const [participants1DivVisible, setParticipants1DivVisible] = useState(false);
  const [practice2DivVisible, setPractice2DivVisible] = useState(false);
  const [participants2DivVisible, setParticipants2DivVisible] = useState(false);
  const [showDivsButtonClicked, setShowDivsButtonClicked] = useState(false);

  const toggleDivs = (practiceDivId, participantsDivId) => {
    if (practiceDivId === 'practice1Div') {
      setPractice1DivVisible(!practice1DivVisible);
      setParticipants1DivVisible(!participants1DivVisible);
    } else if (practiceDivId === 'practice2Div') {
      setPractice2DivVisible(!practice2DivVisible);
      setParticipants2DivVisible(!participants2DivVisible);
    }
  };
  ...
  return (
    <div>
      <div className="navigation-bar">
        ...
        <button className="navigation-bar-practice" onClick={() => toggleDivs('practice1Div', 'participants1Div')}>
          ...
          <button id="practice1Div" className="navigation-bar-button1" style={{ display: practice1DivVisible ? 'block' : 'none' }}>
            <div className="navigation-bar-rectangle">
            <svg
            class="navigation-bar-leaderboard"
            width="24"
          ...
          <a href="participants.html">
            <button id="participants1Div" className="navigation-bar-participants" style={{ display: participants1DivVisible ? 'block' : 'none' }}>
        ...
        <button className="navigation-bar-practice" onClick={() => toggleDivs('practice2Div', 'participants2Div')}>
          ...
          <button id="practice2Div" className="navigation-bar-button1" style={{ display: practice2DivVisible ? 'block' : 'none' }}>
            <div className="navigation-bar-rectangle">
            <svg
            class="navigation-bar-leaderboard"
            width="24"
          ...
          <a href="participants.html">
            <button id="participants2Div" className="navigation-bar-participants" style={{ display: participants2DivVisible ? 'block' : 'none' }}>
              <div className="navigation-bar-group">
                <div className="navigation-bar-participants-div">Учасники</div>
                <svg
              class="navigation-bar-person"
        ...
        <div className="main-recent" id='practice1Div' style={{ display: showDivsButtonClicked ? 'block' : 'none' }}>
          ...
          <div className="main-group-img">
            <div className="main-group">
              <img className="main-rectangle" src="./image/lm.png" />

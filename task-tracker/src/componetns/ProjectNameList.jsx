    ...
    <div>
      {data.map((item) => (
        ...
        localStorage.getItem('userID') == item.author && (
          <div key={item.id}>
          <button className="navigation-bar-practice" onClick={() => handleItemClick(item.id)}>
            <div className="navigation-practice">
              <p>{item.name}</p>
            </div>
            <svg
              ...
              <a href="Parcticipant">
                <button id="participants1Div" className="navigation-bar-participants">
                  <div className="navigation-bar-group">
                    ...
                    <svg
                      className="navigation-bar-person"
                      width="27"
                      height="25"
                      viewBox="0 0 27 25"
                      fill="none"

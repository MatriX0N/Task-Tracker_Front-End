...
const NavigationBoard = () => {
    return (
        <div class="navigation">
            <div class="navigation-task-tracker">TaskTracker</div>
            <div class="online">
                <img class="ava-1" src="image/6e52c5529ce897d39c81652116f731d7.jpg" />
                <img class="ava-2" src="image/6e52c5529ce897d39c81652116f731d7.jpg" />
                <img class="ava-3" src="image/6e52c5529ce897d39c81652116f731d7.jpg" />
            </div>
            <button class="navigation-frame" id="practiceFrameButton">
                <svg
                    class="person-add1"
                    width="23"
                    height="16"
                ...
                <div class="navigation-div">Поділитися</div>
            </button>
            <button class="navigation-group" id="bourd-info1">
                <div class="navigation-ellipse"></div>
                <div class="navigation-ellipse"></div>
                <div class="navigation-ellipse"></div>
            </button>
        </div>
